...
`Во-вторых`, объём кода в процессе разработки модели невелик, а в написании ETL процесса, часто много “домашних заготовок”, которые у DS|DA выработаны годами.

Это означает, что стандартное количество строк до 400 за 1 раз (**_смотри рисунок внимательности ревьюэра, где LOC - количество строк, defects - количество найденных недочетов / ошибок_**), может быть намного меньше, но ошибок наделать можно больше. Например, перепутать количество деревьев, глубину и т.д. в конфигах алгоритма. 
...
• парный ревью, который делает ревьюер и коллега, чей код проверяют (метод, который подходит для пар senior – junior/inter, team lead - team);

• ревью – рассказанная история – процесс ревью, когда ревьюер уже знаком с кодом, но многие решения были не понятны. Тогда создатель кода представляет все решения в виде истории (при возможности с проекцией на бизнес - задачу). 
